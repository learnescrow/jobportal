...
export default function AuthPopup({ open, onClose }: PremiumPopupProps) {
  if (!open) return null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center rounded-3xl overflow-hidden shadow-2xl">
      ...
      <div className="relative w-full max-w-md mx-4 rounded-3xl overflow-hidden shadow-2xl premium-fade">
        <div className="bg-gradient-to-b from-[#100e2e] via-[#17143b] to-[#0c0b23] p-8 w-full h-full">
          ...
          <div className="flex flex-col items-center text-center mb-6">
            ...
            <h2 className="text-white text-3xl font-bold">Complete signup </h2>
            <p className="text-white/70 text-[15px] mt-2 leading-relaxed">
              Login to do payment and unlock premium features.
            </p>
          </div>
          ...
          <div className="mt-5 bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-xl premium-card">
            ...
            <button
              ...
              <span className="relative z-10">Go Signin</span>
            </button>

            <p className="text-white/60 text-center text-xs mt-4">No Spam.</p>
          </div>
        </div>
      </div>
      {/* CSS Animations */}
